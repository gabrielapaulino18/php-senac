...
//Palavras Reservadas e Função Comuns
// echo "Exemplo de uso da função strupper para converter uma string em maiúsculo: " . strtoupper($contatos) . "<br>";

// echo "Exemplo de uso da palavra reservada require para incluir um arquivo: ";
// require 'arquivo.php';
// echo "<br>";

echo "Exemplo de uso de palavra reservada private para definir um método privado privado em uma classe: ";
...
echo "Exemplo de uso da constante mágica __FILE__ para para obter o caminho completo do arquivo atual: " . __FILE__ . "<br>";
